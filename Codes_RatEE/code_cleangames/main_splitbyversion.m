data = W.readtable('../../data_processed/cleaned_games_EE.csv');
info = W.readtable('../../data_processed/cleaned_info_EE.csv');
...
data = data(~tidx,:);
info = info(tidxinfo,:);
W.writetable(td, fullfile(outputdir, 'gameversion_control_G3F6_random.csv'), 'squeeze');
%% control horizon
...
data = data(~tidx,:);
info = info(tidxinfo,:);
W.writetable(td, fullfile(outputdir, 'gameversion_RandH_control_G3F16.csv'), 'squeeze');
...
data = data(~tidx,:);
info = info(tidxinfo,:);
W.writetable(td, fullfile(outputdir, 'gameversion_mixed_long_between.csv'), 'squeeze');
...
data = data(~tidx,:);
info = info(tidxinfo,:);
W.writetable(td, fullfile(outputdir, 'gameversion_G34_within.csv'), 'squeeze');
%% free vs forced
...
data = data(~tidx,:);
info = info(tidxinfo,:);
W.writetable(td, fullfile(outputdir, 'gameversion_G01_within.csv'), 'squeeze');
